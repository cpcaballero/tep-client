...
const MerchantProfile = (props) => {
    ...
    const navMerchantDocuments = () => {
      history.push('merchantDocument')
              ...
              <CardDeck>
                <Card style={{marginTop: "20px"}}> 
                  <Card.Body>
                    <div>
                      <Navbar.Brand href="#">
                        <Image variant="top" src={UploadIcon} width="30" height="auto" /> 
              ...
              <Container style={{ align: "center", marginTop: "40px", marginBottom: "40px"}}>
                <Row>
                    <Col className="text-center">
                        <Button as="input" className="btn-info" type="button" onClick={ navMerchantDocuments } value="Save my business profile" />
                    </Col>    
                </Row>
              </Container>
            </Container>
